// generated on 2020-07-14 using generator-webapp 4.0.0-6
...
function startTestServer() {
  ...
  watch('app/scripts/**/*.js', scripts);
  // run MOCHA via browser using index.html setup
  watch(['test/**/*.js', 'test/index.html']).on('change', server.reload);
